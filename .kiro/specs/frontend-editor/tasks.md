...
- [ ] 2. Implement reactive signal system
  - [ ] 2.1 Create signal primitives (signal, computed, effect)
...
- [ ] 3. Create app shell and layout system
  - [ ] 3.1 Implement root app component with panel layout
  ...
  - [ ] 3.3 Implement panel layout persistence
...
- [ ] 4. Implement theme system
  - [ ] 4.1 Create theme definitions and CSS custom properties
  ...
  - [ ] 4.3 Implement theme toggle and application
  ...
  - [ ] 4.5 Implement theme persistence
...
- [ ] 6. Implement SVG document state management
  - [ ] 6.1 Create document state model
